...
async def get_thumb(videoid, user_id=None):
    ...
    try:
        title_font = ImageFont.truetype("AarumiMusic/assets/font2.ttf", 32)
        regular_font = ImageFont.truetype("AarumiMusic/assets/font.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "AarumiMusic/assets/play_icons.png"
