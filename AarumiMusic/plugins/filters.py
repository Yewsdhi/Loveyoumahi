...
from AarumiMusic.core.call import Alone
...
async def apply_audio_filters(cli, message: Message, _, chat_id):
    ...
    if duration_seconds == 0:
        return await message.reply_text("» ʟɪᴠᴇ sᴛʀᴇᴀᴍs ᴄᴀɴ'ᴛ ʙᴇ ғɪʟᴛᴇʀᴇᴅ.")

    file_path = playing[0]["file"]
    if "downloads" not in file_path:
        return await message.reply_text("» ᴏɴʟʏ ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ᴛʀᴀᴄᴋs ᴄᴀɴ ʙᴇ ғɪʟᴛᴇʀᴇᴅ.")
    ...
    try:
        await Aarumi.apply_filter(chat_id, file_path, filter_type, playing)
